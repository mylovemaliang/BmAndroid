 ...
 * @Version 1.0
 */
public class SearchItemAdapter extends BaseListAdapter<String> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_prompt_item,parent, false);
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder{
        ...
        @Bind(R.id.search_prompt_item_text) TextView itemText;
